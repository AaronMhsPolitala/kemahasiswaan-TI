...
use App\Http\Controllers\User\AspirasiUserController;
...
use App\Http\Controllers\User\UserDivisiController;
use App\Http\Controllers\User\UserPendaftaranController;
...
Route::get('/register', [App\Http\Controllers\User\AuthController::class, 'showRegistrationForm'])->name('register');
...
Route::get('auth/google', [App\Http\Controllers\User\GoogleController::class, 'redirectToGoogle']);
Route::get('auth/google/callback', [App\Http\Controllers\User\GoogleController::class, 'handleGoogleCallback']);
