...
<div class="container-fluid">
    <form class="wa-settings-card" action="{{ route('admin.pengaturan.wa.update') }}" method="POST">
        ...
        <div style="display: flex; gap: 20px; flex-wrap: wrap;">
            ...
            <div style="flex: 1;">
                <h2>Kelola Setting Pesan Tahap 2</h2>

                <label class="label" for="msgLolosWawancara">Pesan untuk Lolos Wawancara</label>
                <textarea
                    class="field"
                    id="msgLolosWawancara"
                    name="pesan_lolos_wawancara"
                    placeholder=""
                    required
                >{{ old('pesan_lolos_wawancara', $pesan_lolos_wawancara ?? '') }}</textarea>

                <label class="label" for="msgGagalWawancara">Pesan untuk Gagal Wawancara</label>
                <textarea
                    class="field"
                    id="msgGagalWawancara"
                    name="pesan_gagal_wawancara"
                    placeholder=""
                    required
