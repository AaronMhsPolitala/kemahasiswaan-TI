    ...
    <section class="table-container">
        <table class="data-table">
            ...
            <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-btns">
                                ...
                                <button type="button" class="btn btn-yellow edit-btn" data-member='{{ json_encode($member) }}' data-update-url="{{ route('admin.anggota.update', $member->id) }}"><i class="fas fa-edit"></i></button>
                ...
                @empty
                    <tr>
                        <td colspan="8" style="text-align: center; padding: 3rem;">Belum ada anggota aktif.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
        ...
        <form id="editForm" method="POST" style="margin-top: 2rem;">
            ...
            <div class="form-group">
                ...
                <select id="edit_jabatan" name="jabatan" required>
                    <option value="Ketua Koordinator">Ketua Koordinator</option>
