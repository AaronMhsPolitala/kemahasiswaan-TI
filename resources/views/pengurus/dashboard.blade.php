...
@section('content')
  ...
  <div class="cards-container">
    <a href="{{ route('pengurus.users.index') }}" class="card" style="text-decoration: none;">
      <div class="card-icon"><i class="fas fa-user"></i></div>
      <div class="card-info"><h3>Data User</h3><p>{{ $userCount }}</p></div>
    </a>
    <a href="{{ route('pengurus.kelola-anggota-himati.index') }}" class="card" style="text-decoration: none;">
      <div class="card-icon"><i class="fas fa-users"></i></div>
      <div class="card-info"><h3>Data Anggota</h3><p>{{ $anggotaCount }}</p></div>
    </a>
    <a href="{{ route('pengurus.berita.index') }}" class="card" style="text-decoration: none;">
      <div class="card-icon"><i class="fas fa-newspaper"></i></div>
      <div class="card-info"><h3>Data Berita</h3><p>{{ $beritaCount }}</p></div>
    </a>
    <a href="{{ route('pengurus.aspirasi.index') }}" class="card" style="text-decoration: none;">
