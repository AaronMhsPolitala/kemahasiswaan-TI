...
<div id="calon-anggota-page">
    ...
    <div class="filter-bar">
        <form action="{{ route('pengurus.calon-anggota-tahap-1.index') }}" method="GET" class="d-flex gap-3">
            ...
            <a href="{{ route('pengurus.calon-anggota-tahap-1.index') }}" class="btn btn-secondary" title="Reset Filter"><i class="fas fa-sync"></i></a>
            <a href="{{ route('pengurus.calon-anggota-tahap-1.exportPdf') }}" class="btn btn-danger" title="Export ke PDF"><i class="fas fa-file-pdf"></i></a>
            <a href="{{ route('pengurus.calon-anggota-tahap-1.exportCsv') }}" class="btn btn-success" title="Export ke CSV"><i class="fas fa-file-csv"></i></a>
        </form>
    </div>
